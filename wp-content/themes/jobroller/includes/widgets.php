...
class JR_Widget_Facebook extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( false, __( ' JobRoller Facebook Like Box', APP_TD ), $widget_ops );
	}
