...
function _jr_load_scripts() {
	...
	if ( $jr_options->jr_google_jquery ) {
		wp_deregister_script('jquery');
		wp_register_script('jquery', ''.$http.'://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js', false, '1.8.3');

		wp_enqueue_script('jquery-ui-custom', ''.$http.'://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/jquery-ui.min.js', array('jquery'), '1.11.3' );
	...
	wp_enqueue_script( 'smoothscroll', get_template_directory_uri() . '/includes/js/smoothscroll.min.js', array( 'jquery' ), '' );
