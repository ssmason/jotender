<div class="section">
	<h2 class="pagetitle">
		...
		<?php echo __('Featured Jobs',APP_TD); ?>
	</h2>
		...
		<?php while ($featured_jobs->have_posts()) : $featured_jobs->the_post(); ?>
			...
			<li class="<?php echo implode( ' ', $post_class ); ?>">
				<dl>
					...
					<dd class="date"><strong><?php echo date_i18n( __( 'j M', APP_TD ), strtotime( $featured_jobs->post->post_date ) ); ?></strong> <span class="year"><?php echo date_i18n( __( 'Y', APP_TD ), strtotime( $featured_jobs->post->post_date ) ); ?></span></dd>
				</dl>
			</li>
		<?php endwhile; ?>
	</ol>
